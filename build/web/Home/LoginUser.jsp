<%-- 
    Document   : LoginUser
    Created on : Nov 29, 2021, 2:41:00 PM
    Author     : hieun
--%>
...
<html>
    ...
    <body>
        <%
            ...
            ArrayList<User> Users = db.LoginUser();
            Boolean kt = true;
            for (User us : Users) {
                ...
                <div class="d-flex flex-lg-row flex-column-reverse">
                    <div class="card card1" style="margin: auto">
                        <div class="row justify-content-center my-auto">
                            <div class="col-md-8 col-10 my-5">
                                ...
                                <form>
                                    ...
                                    <div class="row justify-content-center my-3 px-3"> <input class="btn-block btn-color" name="Login" type="submit" value="Login"/></div>
                        ...
                        <div class="bottom text-center mb-5">
                            <p href="#" class="sm-text mx-auto mb-3">Don't have an account?<a href="SignupUser.jsp"><button class="btn btn-white ml-2">Create new</button></a></p>
                        </div>
                    </div>
