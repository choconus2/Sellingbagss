<%-- 
    Document   : OrdersConfirmation
    Created on : Dec 13, 2021, 12:04:12 PM
    Author     : hieun
--%>
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                                                        ...
                                                        <tbody>
                                                            <%
                                                                ...
                                                                ArrayList<Order> Orders = odd.GetOrders();
                                                                for (Order br : Orders) {
                                                                    out.print("<tr class='gradeX odd' role='row'>");                                                                 
                                                                    out.print("<td>" + br.getUserName()+ "</td>");
                                                                    out.print("<td>" + br.getOrderDate()+ "</td>");
                                                                    out.print("<td><a href='../../Admin/Table/Ordershow.jsp?orderId="+br.getOrderId() + "'>Show Product</a></td> ");
                                                                    out.print("<td><a href='../../Admin/Update/UpdateStatus.jsp?orderId="+br.getOrderId() + "'>order confirmation</a></td> ");
                                                                    out.print("</tr>");
                                                                }
                                                            %>
                                                        </tbody>
